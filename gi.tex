...
\begin{frame}{Some subsets of $ \Omega $ behave nicely}
...
\begin{frame}{But not all subsets have this behavior}
	...
	\begin{center}
		\vspace{-5pt}\begin{columns}
			\begin{column}{0.6\textwidth}
				\begin{itemize}
					\item Let $ \cdot : \Gamma \times \Omega \rightarrow \Omega $ be an action

...
\begin{frame}{The Graph Isomorphism Problem}
	$ \GI $ is the following decision problem:
	...
	\fbox{
		\parbox{0.85\textwidth}{
			...
			\textbf{Question}: Is $ G_1 \cong G_2 $?
		}
	}
	\end{center}

...
\begin{frame}{High-level overview}
	...
	\begin{center}
		\begin{tikzpicture}[thick]
			...
			\draw [decorate, decoration = {brace, raise=5pt, amplitude=5pt, mirror}] (gi.west) -- (si.west) node[pos=0.5,left=10pt,black]{\blocktext{Encode graphs into strings, introduce group}};
			\draw [decorate, decoration = {brace, raise=5pt, amplitude=5pt}] (si.east) -- (algo.east) node[pos=0.5,right=10pt,black]{\blocktext{Use group-theoretic machinery}};
		\end{tikzpicture}
	\end{center}
\end{frame}
...
\begin{frame}{Graphs of bounded degree -- example}
	...
	\begin{center}
		...
		\vspace{-2pt}\begin{tabular}{>{\centering\arraybackslash}m{2cm} >{\centering\arraybackslash}m{1.3cm}|>{\centering\arraybackslash}m{5cm} >{\centering\arraybackslash}m{2cm}}
			...
			\hline\vspace{5pt}\orbitSeven&$ \gen{r,(1\,3)} $&$ \{\id\} \trianglelefteq \gen{r^2} \trianglelefteq \gen{r} \trianglelefteq \gen{r,(1\,3)} $&$ \Z_2, \Z_2, \Z_2 $
		\end{tabular}
	\end{center}\begin{itemize}
		\item Here, $ r := (1\,2\,3\,4) \in S_4 $ is the rotation permutation

...
\setbeamertemplate{title page}{
	...
	\if\fullversion0
	\vskip2em
	{Full version of the presentation available at \textcolor{LightBlueZB}{\href{https://github.com/ZeroBone/LuksAlgoP/releases/latest}{github.com/ZeroBone/LuksAlgoP/releases/latest}}\par}
	\fi
}
...
\begin{frame}{Groups and their composition factors}
	...
	\end{definition}
	\vspace{-5pt}\begin{theorem}[Jordan, Jordan-H{\"o}lder]
		Every group has a composition series. Moreover, the composition factors of any two composition series are equal up to isomorphism and ordering.
